...
**Key takeaway.** Choropleth maps show how area-based values vary across geography.

**Practical use.** Use it when spatial comparison depends on regional boundaries and classification choices.

::: vaa-footer-nav
[Back to Gallery](../../hands-on-gallery.html) [Previous: Exercise 8](../Hands-on_Ex08/Hands-on_Ex08.html) [Next: Exercise 9b](../Hands-on_Ex09b/Hands-on_Ex09b.html)
:::
:::
